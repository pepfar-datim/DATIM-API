...
```{r}
url <- paste0("https://play.im.dhis2.org/dev/api/dataElements.json?",
    ...
    "organisationUnits": [
        {
            ...
            "id": "vWbkYPRmKyS",
            "href": "https://play.im.dhis2.org/dev/api/organisationUnits/vWbkYPRmKyS",
            "level": 3,
